...
class View extends Component {
  ...
  getOpenApiUrl = id => {
    ...
    let encodeId = Encrypt(id)
    return location.protocol + '//' + location.hostname + (location.port !== '' ? ':' + location.port : '') + '/open?id=' + encodeId
  }
      ...
      <div className="caseContainer">
        ...
        <div className="panel-view">
          ...
          <Row className="row">
            ...
            >
              <span className="colValue">
                { this.getOpenApiUrl(this.props.curData._id) }
              </span>
              <Tooltip title="复制地址">
                <Icon
                  type="copy"
                  className="interface-url-icon"
                  onClick={() => this.copyUrl(this.getOpenApiUrl(this.props.curData._id))}
